...
const roles = [
  { id: 'admin', label: 'Admin / Staff', icon: Shield, color: 'danger' },
      ...
      <div className="auth-container">
        <div className="auth-card card-glass">
            ...
            {activeRole === 'admin' && (
              <>
                <div className="form-group">
                  ...
                  <input className="form-input" type="email" placeholder="e.g., admin@medilink.com or doctor@medilink.com" value={form.email} onChange={e => setForm({...form, email: e.target.value})} required id="login-admin-email" />
                </div>
                <div className="form-group">
          ...
          <div className="auth-demo-info">
            ...
            {activeRole === 'admin' && <p>Admin: <strong>admin@medilink.com</strong> / <strong>admin123</strong><br/>Doctor: <strong>doctor@medilink.com</strong> / <strong>doctor123</strong></p>}
