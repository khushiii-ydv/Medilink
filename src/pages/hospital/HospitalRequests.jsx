...
export default function HospitalRequests() {
  ...
  const [newReq, setNewReq] = useState({ toHospitalId: '', type: 'hospital-transfer', condition: '', facility: '', bloodType: '', units: '', transferReason: '' });
  ...
  const handleSendRequest = () => {
    ...
    setNewReq({ toHospitalId: '', type: 'hospital-transfer', condition: '', facility: '', bloodType: '', units: '', transferReason: '' });
  };
